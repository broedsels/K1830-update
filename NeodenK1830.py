...
#Conversion file for Kicad to Neoden K1830, based on https://github.com/szczys/kicad_to_neoden
...
def process_pos_lines(pos_lists):
        output_string = "Designator,Footprint,Mid X,Mid Y,Layer,Ref X,Ref Y,Layer,Pad X,Pad Y,Layer,Rotation,Comment\n"
        output_string += ",,,,,,,,,,\n"
...
def main():
        if len(sys.argv) != 2:
                print("Syntax error!")
                print("Usage: python NeodenK1830.py your_position_file_from_kicad.pos")
                return
